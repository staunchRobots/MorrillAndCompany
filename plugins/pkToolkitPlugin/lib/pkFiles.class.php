...
class pkFiles
{
  static public function getWritableDataFolder($components = array())
  {
    ...
    // app_pkToolkit_writable_indexes_dir (first preference) or 
    // app_pkToolkit_writable_dir (second preference). If app_pkToolkit_writable_indexes_dir
    // is not set, but app_pkToolkit_writable_dir is found, then 
    // /indexes will be appended to app_pkToolkit_writable_dir.
    
    // You may supply more than one component in the array. For instance,
    // getWritableDataFolder(array('indexes', 'purple')) returns
    // sf_data_dir/pk_writable/indexes/purple unless overridden by
    // app_pkToolkit_writable_indexes_purple_dir (first choice), or
    // app_pkToolkit_writable_indexes_dir (second choice), or
    // app_pkToolkit_writable_dir (third choice). 
    ...
    // succeeds except for the top level sf_data_dir/pk_writable folder,
    ...
    // overridden by app_pkToolkit_upload_dir.
    //
    // getUploadFolder(array('media')) returns sf_upload_dir/media 
    // unless overridden by app_pkToolkit_upload_media_dir (first preference) or 
    // app_pkToolkit_upload_dir (second preference). If app_pkToolkit_upload_media_dir
    // is not set, but app_pkToolkit_upload_dir is found, then 
    // /media will be appended to app_pkToolkit_upload_dir.
    
    // You may supply more than one component in the array. For instance,
    // getUploadFolder(array('media', 'jpegs')) returns
    // sf_upload_dir/media/jpegs unless overridden by
    // app_pkToolkit_upload_media_jpegs_dir (first choice), or
    // app_pkToolkit_upload_media_dir (second choice), or
    // app_pkToolkit_upload_dir (third choice).
